...
export default function AccountCreate(){
    ...
    useEffect(()=>{
        axios.get('http://localhost:8080/Employes')
        .then((res)=>{
    ...
    const handleSubmit = (event) => {
        ...
        if ((!form.checkValidity()) || (fnameExist && lnameExist ) || (emailExist )) {
          event.preventDefault();
        ...
        .then(()=>{
            console.log("done"); 
            axios.get(`http://localhost:8080/Employes/full-name/${firstName + lastName}`)
            .then((res)=>{
                setLoading(false);
               setUsers(res.data);
           ...
           <div className="account-page-logo">
               ...
               <section className="form-panel">
                ...
                {fnameExist && lnameExist ? 
                     ...
                     <Alert.Heading>Oh snap! this User name already exist!</Alert.Heading>
                 </Alert>:
                 <></>    
                }
                {emailExist ? 
                     <Alert variant="danger" onClose={() => setShow(false)} dismissible>
                     <Alert.Heading>Oh snap! this email address already exist!</Alert.Heading>
                 </Alert>:
                 <></>    
                }
                ...
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="file" id="profile" onChange={(e)=>{addProfileImage(e)}}  required/>
                        <Form.Control.Feedback type="invalid" className="bold">add a profile</Form.Control.Feedback>
                      
                    </Form.Group>
                    <Form.Group>
                        <Form.Label htmlFor="firstName"/>
                        <Form.Control type="text" id="firstName" onChange={(e)=>{addFirstName(e)}} placeholder="First Name" required/>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="text" id="lastName" onChange={(e)=>{addLastName(e)}} placeholder="Last Name" required/>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="text" id="mail" placeholder="email" onChange={(e)=>{addEmail(e)}} required/>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="tp" id="contact" onChange={(e)=>{addContactNo(e)}} placeholder="Contact No" required/>
                        <Form.Control.Feedback type="invalid" className="bold">Enter your contact number</Form.Control.Feedback>
                    </Form.Group>

                    <Form.Group>
                        <Form.Label htmlFor="address"/>
                        <Form.Control type="text" id="address" onChange={(e)=>{addAddress(e)}} placeholder="Address" required/>
                        <Form.Control.Feedback type="invalid" className="bold">Enter your Address</Form.Control.Feedback>
                    </Form.Group>

                    <Form.Group>
                        <Form.Label htmlFor="position"/>
                        <Form.Control type="text" id="position" onChange={(e)=>{addPosition(e)}} placeholder="position" required/>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="password" id="pw" onChange={(e)=>{addpassword(e)}} placeholder="password" required/>
                        <Form.Control.Feedback type="invalid" className="bold">Enter Correct Password</Form.Control.Feedback>
                       
                    </Form.Group>
                    <Button type="submit" className="btnCreate" onClick={create}><div className="bold">Create</div></Button>
                </Form>
            ...
            <div className={isCreated ? "welcome-alert-container display-block" : "welcome-alert-container display-none"}>
               ...
               <div>
                        ...
                        <h3 className="id-body">Your Employee ID :
              
                            <button className='copy' onClick={()=>setCopied(true)} title={isCopied ? "Copied" : "Copy to clipboard"}>
                                <ClipLoader
                                    color="white"
                                    loading={loading}
                                    size={50}
                                ...
                                <CopyToClipboard text={empId}>
                                    <span> {empId} {isCopied ? <FontAwesomeIcon icon={faCircleCheck} style={{color: "white",}} />:<FontAwesomeIcon icon={faClipboard} style={{color: "white",}}/>} </span>
                                </CopyToClipboard>
                               
                            </button>
                        </h3>
               <Link to='/'><Button type="button" className="btnLogin" title="tooltip">Login</Button></Link>    
               </div>
           </div>
        </div>
    )
